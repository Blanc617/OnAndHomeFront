...
const Cart = () => {
  ...
  const handleIncreaseQuantity = async (cartItemId, currentQuantity) => {
    try {
      const response = await cartAPI.updateQuantity(cartItemId, currentQuantity + 1);
      if (response.success) {
        loadCartItems();
      } else {
          ...
          <>
                ...
                return (
                  <div key={item.id} className="cart-item">
                    ...
                    <div className="item-total">
                      ...
                      <span className="total-price">{formatPrice(itemTotal)}원</span>
                    </div>
            ...
            <div className="cart-summary">
              <div className="summary-row">
                ...
                <span className="summary-value">{formatPrice(getTotalPrice())}원</span>
              </div>
            </div>
